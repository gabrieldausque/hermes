...
const BackEndService_1 = require("./backend/BackEndService");
const TopicService_1 = require("./topic/TopicService");
// Don't remove this comment. It's needed to format import lines nicely.
const app = express_1.default(feathers_1.default());
app.backend = new BackEndService_1.BackEndService();
//topic management :
app.topicService = new TopicService_1.TopicService();
